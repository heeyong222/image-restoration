...
if __name__ == "__main__":
    ...
    # parser.add_argument('--save_path', type = str, default = './efficientderain/20250226_01', help = 'saving path that is a folder')
    # # parser.add_argument('--sample_path', type = str, default = './efficientderain/02', help = 'training samples path that is a folder')
    ...
    # parser.add_argument('--load_name', type = str, default = './efficientderain/v4_SPA.pth', help = 'load the pre-trained model with certain epoch')
    # # GPU parameters
    ...
    # # Dataset parameters
    # parser.add_argument('--baseroot', type = str, default = '/home/heeyong/workspace/data/small_new_old_film_dataset2', help = 'images baseroot')
    ...
    config_path = 'efficientderain/config.yaml'  # YAML 설정 파일 경로
